...
fig_path = os.path.join(abs_dir,f'../../results/covid19_DTM/calibrations/{str(args.agg)}/others/WAVE2/')
# Path where MCMC samples should be saved
samples_path = os.path.join(abs_dir,f'../../data/covid19_DTM/interim/model_parameters/calibrations/{str(args.agg)}/')
